...
public class TxTest {
    ...
    @Test
    public void testVerifyP2WPKH() {
        var tx = TxFetcher.fetch("d869f854e1f8788bcff294cc83b280942a8c728de71eb709a2c29d10bfe21b7c", true);
        assertTrue(tx.verify());
    }

    @Test
    public void testVerifyP2SH_P2WPKH() {
        var tx = TxFetcher.fetch("c586389e5e4b3acb9d6c8be1c19ae8ab2795397633176f5a6442a261bbdefc3a", false);
        assertTrue(tx.verify());
    }

    @Test
    public void testVerifyP2WSH() {
        var tx = TxFetcher.fetch("78457666f82c28aa37b74b506745a7c7684dc7842a52a457b09f09446721e11c", true);
        assertTrue(tx.verify());
    }

    @Test
    public void testVerifyP2SH_P2WSH() {
        var tx = TxFetcher.fetch("954f43dbb30ad8024981c07d1f5eb6c9fd461e2cf1760dd1283f052af746fc88", true);
        assertTrue(tx.verify());
    }
